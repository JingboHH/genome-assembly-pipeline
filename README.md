...
A pair of read may be split seperate into two folder: R1 and R2, with the name DNA1_R1.fq.gz and DNA1_R2.fq.gz
...
```
The main loop to extract the base name of 
...
```
cd existing_repo
git remote add origin https://bioinf-gitlab.biotec.tu-dresden.de/bioinf/gmaa.git
git branch -M main
...
- [ ] [Set up project integrations](https://bioinf-gitlab.biotec.tu-dresden.de/bioinf/gmaa/-/settings/integrations)
